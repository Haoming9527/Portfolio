...
export function Intro() {
  ...
  return (
    <div ref={containerRef} className="grid grid-cols-1 lg:grid-cols-8 gap-4 p-6 lg:p-8">
      ...
      />
      <Card className="intro-fade-in col-span-1 lg:col-span-5 h-full bg-gradient-to-br from-blue-100 to-purple-100 dark:from-blue-950/20 dark:to-purple-950/20 min-h-[400px] lg:min-h-[300px] border border-blue-200/50 dark:border-blue-700/50 order-2 lg:order-1 relative overflow-hidden">
        <DynamicIntroScene />
